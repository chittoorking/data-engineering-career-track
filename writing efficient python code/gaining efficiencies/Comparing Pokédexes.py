...
# output:
# {'Psyduck', 'Squirtle'}
# {'Pikachu', 'Zubat', 'Wigglytuff', 'Rattata', 'Koffing', 'Spearow', 'Bulbasaur', 'Vulpix'}
# {'Spearow', 'Pikachu', 'Zubat', 'Slowbro', 'Vaporeon', 'Starmie', 'Wigglytuff', 'Vulpix', 'Koffing',
#  'Rattata', 'Poliwag', 'Tentacool', 'Horsea', 'Krabby', 'Bulbasaur', 'Magikarp'}
