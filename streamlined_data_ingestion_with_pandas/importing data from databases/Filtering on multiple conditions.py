...
# The weather table contains daily high and low temperatures and precipitation amounts for New York City.
...
# To do this, you'll need to build a query that uses the OR operator to look at values in both columns.
