# Tables in relational databases usually have key columns of unique record identifiers. 
# This lets us build pipelines that combine tables using SQL's JOIN operation, instead of having to combine data after importing it.
...
# In this exercise, you'll join weather data to call records along their common date columns to get everything in one dataframe.
# You can assume these columns have the same data type.
