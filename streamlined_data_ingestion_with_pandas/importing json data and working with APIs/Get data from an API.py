...
# You'll need to extract the data from the response with its json() method, and pass it to pandas's DataFrame() function to make a dataframe.
# Note that the necessary data is under the dictionary key "businesses".
