...
# In this exercise, you'll add an ETL task to an existing DAG. The DAG to extend and the task 
# to wait for are defined in your workspace are defined as dag and wait_for_table respectively.
