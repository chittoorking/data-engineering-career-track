...
#     return run_diff
# A DataFrame has been loaded into your session as giants_df and printed into the console. 
...
# The 'Playoffs' column tells you if a team made the playoffs for a given season.
# A 1 means that the team made the playoffs in that season and a 0 means the team did not make the playoffs in that season.
